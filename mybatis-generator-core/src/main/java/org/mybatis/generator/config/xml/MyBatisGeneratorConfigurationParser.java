...
public class MyBatisGeneratorConfigurationParser {
    ...
    private void parseSqlMapGenerator(Context context, Node node) {
        ...
        sqlMapGeneratorConfiguration.setTargetFilename(targetFilename);
    ...
    private void parseJavaModelGenerator(Context context, Node node) {
        ...
        javaModelGeneratorConfiguration.setTargetFilename(targetFilename);
    ...
    private void parseJavaClientGenerator(Context context, Node node) {
        ...
        javaClientGeneratorConfiguration.setTargetFilename(targetFilename);
