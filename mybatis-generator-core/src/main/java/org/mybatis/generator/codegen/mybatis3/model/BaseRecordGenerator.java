...
public class BaseRecordGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        for (IntrospectedColumn introspectedColumn : introspectedColumns) {
            ...
            // 是否忽略setter和getter方法生成
            String ignoreSetterAndGetter = this.context.getJavaModelGeneratorConfiguration().getProperty("ignoreSetterAndGetter");
            if (!"true".equalsIgnoreCase(ignoreSetterAndGetter)) {
