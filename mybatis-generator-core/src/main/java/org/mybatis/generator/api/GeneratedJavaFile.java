...
public class GeneratedJavaFile extends GeneratedFile {
    ...
    public GeneratedJavaFile(CompilationUnit compilationUnit,
            String targetProject,
            JavaFormatter javaFormatter) {
        this(compilationUnit, targetProject, null, javaFormatter, null);
    }
    ...
    public String getFileName() {
        String filename = stringHasValue(fileName) ?
                fileName : compilationUnit.getType().getShortName();
        compilationUnit.getType().setBaseShortName(filename);
